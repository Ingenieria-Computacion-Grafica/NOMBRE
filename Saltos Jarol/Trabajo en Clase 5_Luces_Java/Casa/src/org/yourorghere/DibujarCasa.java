...
public class DibujarCasa implements Movil{
    ...
    public DibujarCasa(float x, float y, float z, float rx, float ry, float rz, float w, float h, float d, MATERIAL m, GL gl) {
    ...
    public void display(){
        ...
        gl.glScalef(w,h,d);
                    Materiales.materiales.get("cemento");
...
//     gl.glColor3f(.8f,0,0);
        //cara inferior  
        Materiales.materiales.get("rojo");
...
//        Materiales.materiales.get("rojo");
        ...
        //VENTANAS
        Materiales.materiales.get("celeste");
        gl.glBegin(GL.GL_QUADS);
...
//        gl.glColor4f(0,0.5f,0,.5f);
        ...
        //PUERTA
        gl.glBegin(GL.GL_QUADS);
//        Materiales.materiales.get("madera");

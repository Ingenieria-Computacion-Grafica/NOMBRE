 ...
 * @author UCE
 */
public class Transformaciones_Lineales extends JFrame implements KeyListener{
    ...
    public  Transformaciones_Lineales(){
        setTitle("Puntos");
        setSize(700,700);
        setLocation(10,40);
    ...
    public static void main(String args[]){
        Transformaciones_Lineales frame = new Transformaciones_Lineales();
...
//            //gl.glPolygonMode(GL.GL_FRONT,GL.GL_FILL);
//                gl.glColor3f(.5f,.3f,0);
////                gl.glVertex2d(117*(190)/Math.sqrt(190 ^2), 87*(140)/Math.sqrt(140 ^2));//*(140-140)/Math.sqrt(140 ^2)
////                gl.glVertex2d(117*(190)/Math.sqrt(190 ^2), 10*(140)/Math.sqrt(140 ^2));
////                gl.glVertex2d(190*(190)/Math.sqrt(190 ^2), 10*(140)/Math.sqrt(140 ^2));
////                gl.glVertex2d(190*(190)/Math.sqrt(190 ^2), 87*(140)/Math.sqrt(140 ^2));
//                gl.glVertex2d(117, 87);//*(140-140)/Math.sqrt(140 ^2)
//                gl.glVertex2d(117, 10);
//                gl.glVertex2d(190, 10);
//                gl.glVertex2d(190, 87);
//            
